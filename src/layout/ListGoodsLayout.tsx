...
import FilterGoods from '../components/FilterGoods'
import Sort from '../components/Sorted/Sort'
    ...
    <>
      <div className='myFavorite-head'>
            ...
            <div className='listGoods-sort-flex'>
                <div className='listGoods-sort-icon' onClick={() => morePopupFn(<Sort />)}>
                ...
                <div className='listGoods-sort-icon' onClick={() => setFilter(true)}>
      ...
      {filter &&
        <FilterGoods setFilter={setFilter} />
      }
    </>
  )
}
