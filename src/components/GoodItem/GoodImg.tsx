    ...
    return (
      <div className='goodItem-main'>
        ...
        <div className="goodItem-main-image-block">
          ...
          <img src={good.photoGood[0]} alt='goodItem' />
          <img src={good.photoGood[1]} alt='goodItem' />
          <img src={good.photoGood[2]} alt='goodItem' />
          <div className='goodItem-main-image-gallery-arrow'>
          ...
          <img src={good.photoGood[0]} alt='goodItem' className='goodItem-main-image' />
