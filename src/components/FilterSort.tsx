...
const FilterSort = () => {
  ...
  return (
    <div className='filterSort' onClick={() => setIsPopup(true)}>
        <div className='filterSort-svg'>
        ...
        </div>
        {
            ...
            isPopup && <div className='filterSort-bg' onClick={(e: any) => {
                if (e.target.className === "filterSort-bg") {
                  setIsPopup(false);
                }
              }}>
                <div className='filterSort-block'>
